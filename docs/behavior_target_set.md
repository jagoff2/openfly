...
| Visual speed regulation / slowing near nearby objects | Flies slow to visual motion and use optic-flow-like signals to stabilize translational speed, including slowing near nearby structures. | The repo should eventually test translational visual control separately from steering and fixation. | Creamer et al. 2018: `mmc4.pdf` in repo root, DOI `10.1016/j.neuron.2018.10.028` |
