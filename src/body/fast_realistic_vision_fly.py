...
class FastRealisticVisionFly(ConnectomeTurningFly):
    ...
    def post_step(self, sim):
        obs, reward, terminated, truncated, info = ConnectomeTurningFly.post_step(self, sim)
    ...
    def reset(self, *args, **kwargs):
        ...
        obs, info = ConnectomeTurningFly.reset(self, *args, **kwargs)
        self._initialize_vision_network(obs["vision"])
        self._update_visual_buffers(obs["vision"])
        obs, info = self._attach_fast_payload(obs, info)
        return obs, info
